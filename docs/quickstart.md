...
2. The `get_links` returns a [LinkGraph](api/scoring.md#nplinker.scoring.LinkGraph) object that 
   represents the calculated links between the GCFs and other entities as a graph.
