...
def do_stripe(i_ms, names, filter_func, shift, normalise):
    ...
    ii_nloss = ppk_nloss(i_ms.spectrum, i_ms.spectrum, i_ms.parentmass,
                         i_ms.parentmass, sigma_mass, sigma_int)
    ...
    for name in names:
        ...
        jj_nloss = ppk_nloss(j_ms.spectrum, j_ms.spectrum, j_ms.parentmass,
        ...
        results.append((ij_peaks / numpy.sqrt(ii_peaks * jj_peaks),
                        ij_nloss / numpy.sqrt(ii_nloss * jj_nloss)))
