...
def run_bigscape(bigscape_py_path, antismash_path, output_path, pfam_path, extra_params):
    logger.info('run_bigscape: input="{}", output="{}", extra_params={}"'.format(antismash_path, output_path, extra_params))
    ...
    logger.info('BiG-SCAPE completed with return code {}'.format(result.returncode))
