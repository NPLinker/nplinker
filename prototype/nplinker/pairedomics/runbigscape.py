...
def run_bigscape(bigscape_py_path, antismash_path, output_path, pfam_path, cutoffs=[0.3, 0.35, 0.4, 0.45, 0.5, 0.55, 0.6, 0.65, 0.7], mibig=True, mibig_14=False, mibig_13=False, extra_params=None):
